...
function serializeIframeUrl(attrs, props) {
	...
	if (videoMatch) return `${EMBED_BASE}/?video=v${videoMatch[1]}&${serialize(params)}`;
	else if (channelMatch) return `${EMBED_BASE}/?channel=${channelMatch[1]}&${serialize(params)}`;
	return "";
}
var TwitchVideoElement = class extends (globalThis.HTMLElement ?? class {}) {
	...
	#onMessage = async (event) => {
		...
		if (data.namespace === "twitch-embed") {
			...
			} else this.dispatchEvent(new Event(data.eventName));
			...
			if (oldDuration !== this.#playerState.duration) this.dispatchEvent(new Event("durationchange"));
			if (oldCurrentTime !== this.#playerState.currentTime) this.dispatchEvent(new Event("timeupdate"));
			if (oldVolume !== this.#playerState.volume || oldMuted !== this.#playerState.muted) {
				if (this.#playerState.volume !== void 0) this.#volume = this.#playerState.volume;
				if (this.#playerState.muted !== void 0) this.#muted = this.#playerState.muted;
				this.dispatchEvent(new Event("volumechange"));
			}
			if (oldBuffered !== ((_d = (_c = this.#playerState.stats) == null ? void 0 : _c.videoStats) == null ? void 0 : _d.bufferSize)) this.dispatchEvent(new Event("progress"));
		}
	};
...
if (globalThis.customElements && !globalThis.customElements.get("twitch-video")) globalThis.customElements.define("twitch-video", TwitchVideoElement);
var twitch_video_element_default = TwitchVideoElement;
//#endregion
//#region node_modules/twitch-video-element/dist/react.js
...
//# sourceMappingURL=react-C4eJtiCv.js.map