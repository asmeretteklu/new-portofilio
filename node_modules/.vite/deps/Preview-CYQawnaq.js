...
//#region node_modules/react-player/dist/Preview.js
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var ICON_SIZE = "64px";
var cache = {};
var Preview = ({ src, light, oEmbedUrl, onClickPreview, playIcon, previewTabIndex, previewAriaLabel }) => {
	...
	const fetchImage = async ({ src: src2, light: light2, oEmbedUrl: oEmbedUrl2 }) => {
		...
		setImage(null);
		const data = await (await fetch(oEmbedUrl2.replace("{url}", src2))).json();
...
//# sourceMappingURL=Preview-CYQawnaq.js.map