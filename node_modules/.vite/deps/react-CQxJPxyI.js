...
import { n as Hls } from "./hls-CyD0uahI.js";
		...
		async load() {
			...
			if (Hls.isSupported()) {
				...
				this.api.on(Hls.Events.ERROR, (event, data) => {
					if (data.type === Hls.ErrorTypes.NETWORK_ERROR && data.details === Hls.ErrorDetails.FRAG_LOAD_ERROR) lastFailedLevel = data.frag.level;
				});
...
//#endregion
//#region node_modules/hls-video-element/dist/react.js
...
//# sourceMappingURL=react-CQxJPxyI.js.map