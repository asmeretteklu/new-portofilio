...
function getVimeoUrl() {
	var oEmbedParameters = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
var VimeoVideoElement = class extends MediaPlayedRangesMixin(globalThis.HTMLElement ?? class {}) {
	...
	async load() {
		...
		this.api.on("timeupdate", ({ seconds }) => {
			this.#currentTime = Math.round(seconds * 100) / 100;
...
//# sourceMappingURL=react-CDmaQECK.js.map