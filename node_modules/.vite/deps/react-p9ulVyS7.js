...
function serializeIframeUrl(attrs, props = {}) {
	...
	return `${EMBED_BASE}/${matches && matches[1]}?${serialize({
...
var TikTokVideoElement = class TikTokVideoElement extends (globalThis.HTMLElement ?? class {}) {
	...
	async load() {
		...
		if (!this.shadowRoot) this.attachShadow(TikTokVideoElement.shadowRootOptions);
...
if (globalThis.customElements && !globalThis.customElements.get("tiktok-video")) globalThis.customElements.define("tiktok-video", TikTokVideoElement);
var tiktok_video_element_default = TikTokVideoElement;
//#endregion
//#region node_modules/tiktok-video-element/dist/react.js
...
//# sourceMappingURL=react-p9ulVyS7.js.map